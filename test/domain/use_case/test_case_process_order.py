...
from event_driven.domain.schemas import OrderCreatedModel, PaymentModel, CartItemModel
...
class TestProcessOrderUseCase(unittest.TestCase):
    ...
    def test_execute_successful_order_processing(self) -> None:
        ...
        result: Optional[PaymentModel] = self.use_case.execute(payload)
