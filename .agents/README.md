...
3. Skills from the `skills` folder are the building blocks for agents. Each skill is a self-contained module that can be composed to create complex agent behaviors.
